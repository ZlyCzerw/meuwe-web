...
const en: Resources = {
  ...
  eventList: {
    open: 'Event list',
    title: 'Events nearby',
    count_one: '{{count}} event within {{km}} km',
    count_two: '{{count}} events within {{km}} km',
    count_few: '{{count}} events within {{km}} km',
    count_many: '{{count}} events within {{km}} km',
    count_other: '{{count}} events within {{km}} km',
    countNearPlace_one: '{{count}} event within {{km}} km of the chosen place',
    countNearPlace_two: '{{count}} events within {{km}} km of the chosen place',
    countNearPlace_few: '{{count}} events within {{km}} km of the chosen place',
    countNearPlace_many: '{{count}} events within {{km}} km of the chosen place',
    countNearPlace_other: '{{count}} events within {{km}} km of the chosen place',
    mapCenter: 'Map centre',
    showMore: 'Show more (+{{km}} km)',
    empty: 'Nothing found here',
    emptyHint: 'Try other days, filters or search another place',
    interactions: 'Interest: messages and followers',
  },
  event: {
    organizer: 'Added by',
    conversation: 'Chat',
    ...
    viewCount_two: '{{count}} views',
    viewCount_few: '{{count}} views',
    viewCount_many: '{{count}} views',
    viewCount_other: '{{count}} views',
    viewerCount_one: '{{count}} person',
    viewerCount_two: '{{count}} people',
    viewerCount_few: '{{count}} people',
    viewerCount_many: '{{count}} people',
    viewerCount_other: '{{count}} people',
