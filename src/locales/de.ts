...
const de: Resources = {
  ...
  eventList: {
    ...
    count_one: '{{count}} Event im Umkreis von {{km}} km',
    count_two: '{{count}} Events im Umkreis von {{km}} km',
    count_few: '{{count}} Events im Umkreis von {{km}} km',
    count_many: '{{count}} Events im Umkreis von {{km}} km',
    count_other: '{{count}} Events im Umkreis von {{km}} km',
    countNearPlace_one: '{{count}} Event im Umkreis von {{km}} km um den gewählten Ort',
    countNearPlace_two: '{{count}} Events im Umkreis von {{km}} km um den gewählten Ort',
  ...
  event: {
    ...
    messages: 'Nachr.',
    views: 'Aufrufe',
    viewCount_one: '{{count}} Aufruf',
    viewCount_two: '{{count}} Aufrufe',
    viewCount_few: '{{count}} Aufrufe',
    viewCount_many: '{{count}} Aufrufe',
    viewCount_other: '{{count}} Aufrufe',
    viewerCount_one: '{{count}} Person',
    viewerCount_two: '{{count}} Personen',
    viewerCount_few: '{{count}} Personen',
    viewerCount_many: '{{count}} Personen',
    viewerCount_other: '{{count}} Personen',
  ...
  userCard: {
    follow: '+ Folgen',
    following: 'Du folgst ✓',
    followingHint: 'Du wirst über jede neue Veranstaltung dieser Person benachrichtigt',
  ...
  landing: {
    ...
    cookies: {
      ...
      body: 'Wir nutzen Cookies, damit die Seite funktioniert und wir verstehen, wie du sie nutzt. Ohne Werbung.',
      ...
      close: 'Schließen',
      necessary: 'Notwendig',
      necessaryDesc: 'Merken sich deine Sprache und deine Cookie-Wahl. Immer aktiv.',
      analytics: 'Analyse',
      analyticsDesc: 'Helfen uns zu verstehen, wie du meuwe nutzt (Google Analytics), damit wir es verbessern können.',
      privacy: 'Datenschutzerklärung',
    },
    footer: {
