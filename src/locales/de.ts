...
const de: Resources = {
  ...
  landing: {
    ...
    f1Eyebrow: 'Karte statt Feed',
    f1Title: 'Der Startbildschirm\nist eine Karte,\nkein Scroll',
    f1Body: 'Du öffnest die App und siehst sofort, was in deiner Umgebung passiert — in Echtzeit. Jeder Pin ist ein anderes Event. Kein endloser Feed.',
    ...
    f3Title: 'Event\nin 10 Sekunden',
    f3Body: 'Der Titel ist das einzige Pflichtfeld. Alles andere — optional. Dein Event erscheint sofort auf der Karte und jeder in der Nähe kann es finden.',
    ...
    downloadBody: 'Lade die App herunter und entdecke, was in deiner Umgebung passiert — jetzt.',
  },
  blog: {
    title: 'Blog',
