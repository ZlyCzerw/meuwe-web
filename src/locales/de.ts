...
const de: Resources = {
  ...
  map: {
    ...
    emptyWider: 'Nächstes Event {{km}} km entfernt',
    emptyWiderCta: 'Weiter umsehen',
  ...
  account: {
    ...
    nicknameTitle: 'Benutzername',
    nicknameCurrent: 'Dein Name',
    nicknameNew: 'Neuer Name',
    nicknameSave: 'Speichern',
    nicknameSaved: 'Name geändert',
    ...
    body: 'Wir speichern die E-Mail-Adresse deiner Anmeldung, deinen Namen und deine Avatarfarbe, deine Benachrichtigungseinstellungen sowie die Events und Nachrichten, die du schreibst. Dein letzter Standort dient nur dazu, Benachrichtigungen über Events in der Nähe zu filtern.',
