...
const sl: Resources = {
  ...
  eventList: {
    open: 'Seznam dogodkov',
    title: 'Dogodki v bližini',
    count_one: '{{count}} dogodek do {{km}} km',
    count_two: '{{count}} dogodka do {{km}} km',
    count_few: '{{count}} dogodki do {{km}} km',
    count_many: '{{count}} dogodkov do {{km}} km',
    count_other: '{{count}} dogodkov do {{km}} km',
    countNearPlace_one: '{{count}} dogodek do {{km}} km od izbranega kraja',
    countNearPlace_two: '{{count}} dogodka do {{km}} km od izbranega kraja',
    countNearPlace_few: '{{count}} dogodki do {{km}} km od izbranega kraja',
  ...
  event: {
    ...
    messages: 'sporoč.',
    views: 'ogledi',
    viewCount_one: '{{count}} ogled',
    viewCount_two: '{{count}} ogleda',
    viewCount_few: '{{count}} ogledi',
    viewCount_many: '{{count}} ogledov',
    viewCount_other: '{{count}} ogledov',
    viewerCount_one: '{{count}} oseba',
    viewerCount_two: '{{count}} osebi',
    viewerCount_few: '{{count}} osebe',
    viewerCount_many: '{{count}} oseb',
    viewerCount_other: '{{count}} oseb',
  ...
  landing: {
    ...
    cookies: {
      title: 'Spoštujemo tvojo zasebnost',
      body: 'Piškotke uporabljamo, da stran deluje pravilno in da vemo, kako jo uporabljaš. Brez oglasov.',
      ...
      close: 'Zapri',
      necessary: 'Nujni',
      necessaryDesc: 'Zapomnijo si tvoj jezik in tvojo izbiro glede piškotkov. Vedno vklopljeni.',
      analytics: 'Analitični',
      analyticsDesc: 'Pomagajo nam razumeti, kako uporabljaš meuwe (Google Analytics), da ga lahko izboljšamo.',
      privacy: 'Politika zasebnosti',
    },
    footer: {
      terms: 'Pogoji',
