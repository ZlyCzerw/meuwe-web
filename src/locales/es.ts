...
const es: Resources = {
  ...
  map: {
    ...
    searchAll: 'Busca un lugar o evento…',
    ...
    closeTimeline: 'Cerrar la barra de fechas',
  ...
  eventList: {
    open: 'Lista de eventos',
    title: 'Eventos cerca',
    count_one: '{{count}} evento a menos de {{km}} km',
    count_two: '{{count}} eventos a menos de {{km}} km',
    count_few: '{{count}} eventos a menos de {{km}} km',
    count_many: '{{count}} eventos a menos de {{km}} km',
    count_other: '{{count}} eventos a menos de {{km}} km',
    countNearPlace_one: '{{count}} evento a menos de {{km}} km del lugar elegido',
    countNearPlace_two: '{{count}} eventos a menos de {{km}} km del lugar elegido',
    countNearPlace_few: '{{count}} eventos a menos de {{km}} km del lugar elegido',
  ...
  event: {
    ...
    messages: 'mens.',
    views: 'vistas',
    viewCount_one: '{{count}} vista',
    viewCount_two: '{{count}} vistas',
    viewCount_few: '{{count}} vistas',
    viewCount_many: '{{count}} vistas',
    viewCount_other: '{{count}} vistas',
    viewerCount_one: '{{count}} persona',
    viewerCount_two: '{{count}} personas',
    viewerCount_few: '{{count}} personas',
    viewerCount_many: '{{count}} personas',
    viewerCount_other: '{{count}} personas',
  ...
  userCard: {
    follow: '+ Seguir',
    following: 'Siguiendo ✓',
    followingHint: 'Te avisaremos de cada nuevo evento de esta persona',
    thisIsYou: 'Eres tú',
  ...
  landing: {
    ...
    cookies: {
      ...
      body: 'Usamos cookies para que la web funcione bien y para saber cómo la usas. Sin anuncios.',
      ...
      necessaryDesc: 'Recuerdan tu idioma y tu elección sobre cookies. Siempre activas.',
      analytics: 'Analíticas',
      analyticsDesc: 'Nos ayudan a entender cómo usas meuwe (Google Analytics) para poder mejorarlo.',
      privacy: 'Política de privacidad',
    },
    footer: {
      terms: 'Términos',
