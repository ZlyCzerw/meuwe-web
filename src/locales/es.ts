...
const es: Resources = {
  ...
  landing: {
    ...
    f1Eyebrow: 'Mapa en lugar de feed',
    f1Title: 'La pantalla\nprincipal es\nun mapa',
    f1Body: 'Abres la app y ves al instante lo que pasa en tu zona — en tiempo real. Cada pin es un evento diferente. Sin feed infinito.',
    ...
    f3Title: 'Evento\nen 10 segundos',
    f3Body: 'El título es el único campo obligatorio. Lo demás — opcional. Tu evento aparece en el mapa al instante y cualquiera en la zona puede encontrarlo.',
    ...
    downloadBody: 'Descarga la app y empieza a descubrir lo que pasa en tu zona — ahora.',
  },
  blog: {
    title: 'Blog',
