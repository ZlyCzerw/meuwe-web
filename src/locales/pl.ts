const pl = {
  ...
  eventList: {
    open: 'Lista wydarzeń',
    title: 'Wydarzenia w pobliżu',
    count_one: '{{count}} wydarzenie do {{km}} km',
    count_two: '{{count}} wydarzenia do {{km}} km',
    count_few: '{{count}} wydarzenia do {{km}} km',
    count_many: '{{count}} wydarzeń do {{km}} km',
    count_other: '{{count}} wydarzeń do {{km}} km',
    countNearPlace_one: '{{count}} wydarzenie do {{km}} km od wybranego miejsca',
    countNearPlace_two: '{{count}} wydarzenia do {{km}} km od wybranego miejsca',
    countNearPlace_few: '{{count}} wydarzenia do {{km}} km od wybranego miejsca',
  ...
  event: {
    ...
    messages: 'wiad.',
    views: 'wyśw.',
    viewCount_one: '{{count}} wyświetlenie',
    viewCount_two: '{{count}} wyświetlenia',
    viewCount_few: '{{count}} wyświetlenia',
    viewCount_many: '{{count}} wyświetleń',
    viewCount_other: '{{count}} wyświetleń',
    viewerCount_one: '{{count}} osoba',
    viewerCount_two: '{{count}} osoby',
    viewerCount_few: '{{count}} osoby',
    viewerCount_many: '{{count}} osób',
    viewerCount_other: '{{count}} osób',
  ...
  landing: {
    ...
    cookies: {
      ...
      body: 'Używamy plików cookie, żeby strona działała poprawnie i żeby wiedzieć, jak z niej korzystasz. Bez reklam.',
      ...
      close: 'Zamknij',
      necessary: 'Niezbędne',
      necessaryDesc: 'Pamiętają Twój język i wybór dotyczący cookies. Zawsze aktywne.',
      analytics: 'Analityczne',
      analyticsDesc: 'Pomagają nam zrozumieć, jak korzystasz z meuwe (Google Analytics), dzięki czemu możemy je ulepszać.',
      privacy: 'Polityka prywatności',
    },
    footer: {
      terms: 'Regulamin',
