const pl = {
  ...
  landing: {
    ...
    f1Eyebrow: 'Mapa zamiast feedu',
    f1Title: 'Ekran główny\nto mapa,\nnie scroll',
    f1Body: 'Otwierasz aplikację i od razu widzisz co się dzieje w Twojej okolicy — w czasie rzeczywistym. Każdy pin to inne wydarzenie. Żadnego nieskończonego feedu.',
    ...
    f3Title: 'Wydarzenie\nw 10 sekund',
    f3Body: 'Tytuł to jedyne wymagane pole. Reszta — opcjonalnie. Twoje wydarzenie pojawia się na mapie natychmiast i każdy w okolicy może je znaleźć.',
    ...
    downloadBody: 'Pobierz aplikację i zacznij odkrywać co się dzieje w Twojej okolicy — teraz.',
  },
  blog: {
    title: 'Blog',
