const pl = {
  ...
  onboarding: {
    ...
    interestsTitle: 'Co Cię interesuje?',
    interestsBody: 'Wybierz, o czym mamy dawać znać. Bez tego nowe wydarzenia obok Ciebie przejdą bokiem.',
    interestsRadius: 'Jak daleko szukamy',
