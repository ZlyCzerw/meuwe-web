...
export const RZESZOW_VENUES: VenueEntry[] = [
  ...
  { name: 'Galeria Nierzeczywista RSF', city: 'Rzeszów', lat: 50.03805, lng: 22.00334,
    aliases: ['galeria nierzeczywista rsf', 'nierzeczywista rsf'] },
  { name: 'Biuro Wystaw Artystycznych w Rzeszowie', city: 'Rzeszów', lat: 50.03869, lng: 22.00757,
    aliases: ['biuro wystaw artystycznych w rzeszowie', 'bwa rzeszow'] },
  { name: 'Muzeum Etnograficzne im. Franciszka Kotuli', city: 'Rzeszów', lat: 50.03706, lng: 22.00464,
    aliases: ['muzeum etnograficzne', 'muzeum etnograficzne im franciszka kotuli'] },
  { name: 'Rzeszowskie Piwnice / Skwer Kultury', city: 'Rzeszów', lat: 50.03749, lng: 22.00496,
    aliases: ['rzeszowskie piwnice', 'skwer kultury'] },
  { name: 'Plac Farny', city: 'Rzeszów', lat: 50.03786, lng: 22.00148,
    aliases: ['plac farny'] },
  ...
  { name: 'Zespół Szkół Gospodarczych', city: 'Rzeszów', lat: 50.03573, lng: 22.01167,
    aliases: ['zespol szkol gospodarczych', 'zespol szkol gospodarczych w rzeszowie'] },
  ...
  { name: 'ALOHA Food, Bowling & Club', city: 'Rzeszów', lat: 50.04870, lng: 21.97640,
    aliases: ['aloha food bowling club'] },
  ...
  { name: 'Place zabaw na Osiedlu Baranówka', city: 'Rzeszów', lat: 50.05587, lng: 21.97857,
    aliases: ['place zabaw na osiedlu baranowka', 'place zabaw baranowka'] },
